-- Onboarding slots: hard cap access control (global)
...
CREATE INDEX IF NOT EXISTS onboarding_slots_status_idx ON onboarding_slots(status);
CREATE INDEX IF NOT EXISTS onboarding_slots_expires_idx ON onboarding_slots(expires_at);
