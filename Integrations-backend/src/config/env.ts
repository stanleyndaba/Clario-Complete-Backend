...
const config = {
  ...
  PAYSTACK_RECOVERY_WORKSPACE_PLAN_CODE: process.env.PAYSTACK_RECOVERY_WORKSPACE_PLAN_CODE,
  PAYSTACK_SUBSCRIPTION_GRACE_DAYS: toInt(process.env.PAYSTACK_SUBSCRIPTION_GRACE_DAYS, 3),
