...
describe('forensic Audit Results to commercial boundary', () => {
  ...
  it('requires previous-period evidence before recurring high burden can route to Talk to Sales', () => {
    ...
    expect(decision.commercial_reason).toContain('operational-burden score of 18');
  });
  ...
  it('uses existing Workspace as the explicit Talk-to-Sales basis without claiming Enterprise or Scale', () => {
